...
static ScriptItem const TheScript[] = {
  ...
  { "using deep neural networks. Try it! Draw a number on paper ...", 0, 0 },
  { "and point JeVois towards it. Adjust distance until the number fits", 0, 0 },
  { "in the attention pink square.", 0, 0 },
