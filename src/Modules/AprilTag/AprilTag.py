...
class AprilTag:
    ...
    def init(self):
        ...
        pc = jevois.ParameterCategory("AprilTag Parameters", "")
        self.dic = jevois.Parameter(self, 'dictionary', 'str', "Dictionary to use", 'tag36h11', pc)
    ...
    def processGUI(self, inframe, helper):
        ...
        if (self.detector):
            ...
            for r in results:
                ...
                #jevois.sendSerialContour2D(ingray.shape[1], ingray.shape[0], r.corners, "A" + r.tag_id)
